...
class UserDetail extends StatelessWidget {
  ...
  UserDetail({Key? key, required this.user, required this.size})
      : super(key: key);
                      ...
                      children: [
                        const Text('Ngày đăng ký: ',
                            style: TextStyle(
                                fontSize: 16, fontWeight: FontWeight.w500)),
                        Text(f.format(
                            inputFormat.parse(user.registerAt.toString()))),
                      ],
                    ),
                    ...
                    Row(
                      children: [
                        ElevatedButton.icon(
                          onPressed: () {
                            Navigator.of(context).push(
                                scaleInTransition(EditUserDetailScreen()));
                          },
                          icon: const Icon(
                            Icons.near_me,
                            color: secondaryColor40LightTheme,
                        ...
                        ElevatedButton.icon(
                          onPressed: () {
                            Navigator.of(context).push(
                                scaleInTransition(const FollowingListScreen()));
                          },
                          icon: const Icon(
                            Icons.favorite,
                            color: secondaryColor40LightTheme,
